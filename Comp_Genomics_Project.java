...
public class HBGodev {
	...
	public static void main(String[] args) throws IOException{
		...
		String[] options= {"Kendim DNA Dizilimi Girecegim","Rastgele DNA Dizilimi"};
	...
	public static void bilgisor() {
		...
		if(G==0)	//DNA dizilimi kullanici tarafindan girildiginde bu alanin sorulmasini engelleyen kosul.
			G= Integer.parseInt(JOptionPane.showInputDialog("Istediğiniz DNA uzunlugunu giriniz."));
		
		N= Integer.parseInt(JOptionPane.showInputDialog("Istediğiniz sekans adedini giriniz."));
		L= Integer.parseInt(JOptionPane.showInputDialog("Her bir sekansın uzunlugunu giriniz."));
		T= Integer.parseInt(JOptionPane.showInputDialog("Skor Matrisinde kabul edilebilecek olan en kucuk (T) skorunu giriniz."));
	...
	public static String[][] skorlama(String[] sekans,String[] tumleyen) {
		...
		//Matrisin ust ucgenindeki skorlamalarını yapan donguler(k<l icin rk,rl karsilastirmasi). 
			for(int m=0;m<N;m++) {
				for(int t=m+1;t<N;t++) {
					//Skorlama islemi.
					for(int i=1;i<L;i++) {
		...
		//Matrisin alt ucgenindeki skorlamalarını yapan donguler(k>l icin rk,rl komplement karsilastirmasi). 
			for(int m=0;m<N;m++) {
				for(int t=0;t<m+1;t++) {
					for(int i=1;i<L;i++) {
						for(int j=1;j<L;j++) {
	...
	public static void layout(String[][] OverlapMatris,String[] sekans1,String[] tumleyensekans) {
		...
		while(true) {
			...
			//Karsilastiracak sekans kalmayınca sonsuz donguyu sonlandıran kosul.
			else
				break;
